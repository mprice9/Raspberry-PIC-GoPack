...
MP_LINKER_FILE_OPTION=,--script="..\..\..\..\..\..\..\..\ProgramFiles_x86\Microchip\xc16\v1.26\support\dsPIC33F\gld\p33FJ64MC204.gld"
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/RPI_shield.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../../../../../../../ProgramFiles_x86/Microchip/xc16/v1.26/support/dsPIC33F/gld/p33FJ64MC204.gld
